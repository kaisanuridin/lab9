...
coin_img_orig = pygame.image.load(r"C:\Users\Lenovo\Downloads\coin.png").convert_alpha()
coin_img_orig = pygame.transform.scale(coin_img_orig, (30, 30))

enemy_car_img = pygame.image.load(r"C:\Users\Lenovo\Downloads\enemy_car.png").convert_alpha()
